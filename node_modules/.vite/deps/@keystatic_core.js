...
import { v as require_dist } from "./base64-3538d789-BPU58W_d.js";
import { $ as refreshCwIcon, $i as Button, $r as _Menu, A as mdx, Bn as useImageLibraryURL, Bt as basicFormFieldWithSimpleReaderParse, Ct as FieldDataError, D as getUploadedFile, Dn as text, E as getSrcPrefix, Ea as tokenSchema, G as useIsInDocumentEditor, Gn as useTree, Gt as fixPath, Hi as TextLink, Ii as FieldDescription, It as SlugFieldContext, Ki as Flex, Kr as Dialog, L as singleton, La as css, Li as FieldLabel, Lt as UploadImageButton, M as pluralize, Ni as TextArea, Nt as NotEditable, O as isValidURL$1, Ot as ImageDimensionsInput, Pa as isString, Pi as TextField, Pn as useConfig, Pt as PathContext, Q as require_escape_string_regexp, Qi as ActionButton, Qr as MenuTrigger, R as strings, Ri as FieldMessage, Rt as assertRequired, S as getInitialPropsValue, Ui as require_lib, Ur as NumberField, Ut as emptyImageData, V as useArrayFieldValidationMessage, Vi as $191c9b6d48a0a4e2$export$294aa081a6c6f55d, W as useFieldSpan, Wi as Box, Wr as trash2Icon, X as valueToUpdater, Xr as imageIcon, Ya as $cf2482eff2eeeec2$export$f12b703ca79dfbb1, Yi as VStack, Yn as validateText, Yr as useDialogContainer, Z as require_slugify, Zr as _Picker, _ as collection, _n as loadImageData, aa as Heading, b as createGetPreviewProps, ci as Checkbox, ea as ButtonGroup, et as filter, g as clientSideValidateProp, h as ToolbarSeparator, ha as Content, ia as ProgressCircle, ii as useDragAndDrop, it as require_dist$1, k as markdoc, mt as _ListView, n as ArrayFieldListView, nt as _ActionBarContainer, o as FormValueContentFromPreviewProps, oa as Text, q as useObjectURL, qr as DialogContainer, r as BlockWrapper$1, ra as Icon, ri as move, s as ImageFieldInput, st as _Combobox, t as useSlugsInCollection, ta as ClearButton, ti as $05678f3aee5e7d1a$export$6d08773d2e66f8f2, tt as _ActionBar, v as config, vn as object, wa as containerQueries, wo as c, x as document$1, yn as parseImageData, zn as useEventCallback } from "./useSlugsInCollection-1b3fd80d-D6VSIbAr.js";
//#region node_modules/@keystatic/core/dist/api-cb694623.js
...
//#endregion
//#region node_modules/@keystatic/core/dist/index-a7364a0a.js
...
function IntegerFieldInput(props) {
	...
	if ($[6] !== props.label || $[7] !== props.description || $[8] !== props.autoFocus || $[9] !== t1 || $[10] !== t2 || $[11] !== onBlur || $[12] !== t3 || $[13] !== t4) {
		t5 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(NumberField, {
			label: props.label,
...
function SelectFieldInput(props) {
	...
	if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
		t3 = (item) => /*#__PURE__*/ (0, import_jsx_runtime.jsx)($05678f3aee5e7d1a$export$6d08773d2e66f8f2, { children: item.label }, item.value);
		$[4] = t3;
	} else t3 = $[4];
	let t4;
	if ($[5] !== props.label || $[6] !== props.description || $[7] !== props.options || $[8] !== props.value || $[9] !== props.autoFocus || $[10] !== t0 || $[11] !== t2) {
		t4 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(_Picker, {
			label: props.label,
			description: props.description,
			items: props.options,
...
function BlocksFieldInput(props) {
	...
	const [modalState, setModalState] = (0, import_react.useState)(t0);
	let t1;
	...
	const { descriptionProps, errorMessageProps, fieldProps: groupProps, labelProps } = $191c9b6d48a0a4e2$export$294aa081a6c6f55d(t3);
	const t4 = minLength > 0;
	let t5;
	if ($[7] !== t4 || $[8] !== labelProps || $[9] !== props.schema.label) {
		t5 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(FieldLabel, {
			elementType: "span",
			isRequired: t4,
	...
	if ($[11] !== props.schema.description || $[12] !== descriptionProps) {
		t6 = props.schema.description && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(FieldDescription, {
			...descriptionProps,
	...
	if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
		t7 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(ActionButton, {
			alignSelf: "start",
			children: "Add"
		});
		$[14] = t7;
	...
	if ($[17] === Symbol.for("react.memo_cache_sentinel")) {
		t9 = (item) => /*#__PURE__*/ (0, import_jsx_runtime.jsx)($05678f3aee5e7d1a$export$6d08773d2e66f8f2, { children: item.label }, item.value.toString());
		$[17] = t9;
	} else t9 = $[17];
	let t10;
	if ($[18] !== props.schema.element.discriminant.options || $[19] !== t8) {
		t10 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(MenuTrigger, { children: [t7, /*#__PURE__*/ (0, import_jsx_runtime.jsx)(_Menu, {
	...
	let t12;
	if ($[22] !== props) {
		t12 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(ArrayFieldListView, {
			...props,
	...
	if ($[24] !== errorMessage || $[25] !== errorMessageProps) {
		t13 = errorMessage && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(FieldMessage, {
			...errorMessageProps,
	...
	bb0: {
		...
		if (modalState.kind === "edit") {
			...
			const { discriminant: discriminant_0 } = props.elements[idx_0];
			let t15;
			...
			let t16;
			if ($[30] !== t15) {
				t16 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(Heading, { children: [
					"Edit",
					" ",
					t15
				] });
			...
			if ($[32] !== formId || $[33] !== previewProps || $[34] !== idx_0) {
				t17 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(BlocksEditItemModalContent, {
					formId,
					onClose: dismiss,
					previewProps,
			...
			let t18;
			if ($[36] !== formId) {
				t18 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(ButtonGroup, { children: /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Button, {
					form: formId,
					prominence: "high",
					type: "submit",
					children: "Done"
			...
			if ($[38] !== t16 || $[39] !== t17 || $[40] !== t18) {
				t19 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(Dialog, { children: [
					t16,
					t17,
					t18
				] });
		...
		if ($[47] !== discriminant_1 || $[48] !== formId || $[49] !== props) {
			t17 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Content, { children: /*#__PURE__*/ (0, import_jsx_runtime.jsx)(BlocksAddItemModalContent, {
		...
		let t19;
		if ($[53] !== t18) {
			t19 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Button, {
				onPress: dismiss,
				children: t18
			});
			$[53] = t18;
		...
		let t21;
		if ($[57] !== formId || $[58] !== t20) {
			t21 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Button, {
				form: formId,
				prominence: "high",
				type: "submit",
				children: t20
		...
		let t22;
		if ($[60] !== t19 || $[61] !== t21) {
			t22 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(ButtonGroup, { children: [t19, t21] });
			$[60] = t19;
			$[61] = t21;
			$[62] = t22;
		} else t22 = $[62];
		...
		if ($[63] !== t16 || $[64] !== t17 || $[65] !== t22) {
			t23 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(Dialog, { children: [
				t16,
				t17,
				t22
			] });
	...
	let t15;
	if ($[67] !== t14) {
		t15 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(DialogContainer, {
			onDismiss: dismiss,
			children: t14
		});
		$[67] = t14;
	...
	if ($[69] !== groupProps || $[70] !== t5 || $[71] !== t6 || $[72] !== t10 || $[73] !== t12 || $[74] !== t13 || $[75] !== t15) {
		t16 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(VStack, {
			gap: "medium",
			role: "group",
			minWidth: 0,
			...groupProps,
...
function BlocksEditItemModalContent(props) {
	...
	if ($[2] !== props.previewProps) {
		t1 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(FormValueContentFromPreviewProps, {
			autoFocus: true,
			...props.previewProps
		});
	...
	if ($[4] !== props.formId || $[5] !== t0 || $[6] !== t1) {
		t2 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Content, { children: /*#__PURE__*/ (0, import_jsx_runtime.jsx)(VStack, {
			id: props.formId,
			elementType: "form",
			onSubmit: t0,
			gap: "xxlarge",
...
function BlocksAddItemModalContent(props) {
	...
	const [value, setValue] = (0, import_react.useState)(() => getInitialPropsValue(schema));
	const [forceValidation, setForceValidation] = (0, import_react.useState)(false);
	const previewProps = (0, import_react.useMemo)(() => createGetPreviewProps(schema, setValue, () => void 0), [schema, setValue])(value);
	const { dismiss } = useDialogContainer();
	return /*#__PURE__*/ (0, import_jsx_runtime.jsx)(VStack, {
		id: props.formId,
		elementType: "form",
		onSubmit: (event) => {
			if (event.target !== event.currentTarget) return;
			...
			props.previewProps.onChange([...props.previewProps.elements.map((x) => ({ key: x.key })), {
				key: void 0,
		...
		gap: "xxlarge",
		children: /*#__PURE__*/ (0, import_jsx_runtime.jsx)(FormValueContentFromPreviewProps, {
			forceValidation,
			autoFocus: true,
			...previewProps
		})
...
function CheckboxFieldInput(props) {
	...
	let t0;
	if ($[0] !== props.label) {
		t0 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Text, { children: props.label });
		$[0] = props.label;
		$[1] = t0;
	} else t0 = $[1];
	let t1;
	if ($[2] !== props.description) {
		t1 = props.description && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Text, {
			slot: "description",
	...
	if ($[4] !== props.value || $[5] !== props.onChange || $[6] !== props.autoFocus || $[7] !== t0 || $[8] !== t1) {
		t2 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(Checkbox, {
...
function ImageField(props) {
	...
	const [status, setStatus] = (0, import_react.useState)(image.src ? "good" : "");
	const imageLibraryURL = useImageLibraryURL();
	let t0;
	if ($[0] !== props) {
		t0 = (event) => {
			event.preventDefault();
			const parsed = parseImageData(event.clipboardData.getData("text/plain"));
	...
	if ($[4] !== props.image.src || $[5] !== hasSetFields || $[6] !== config || $[7] !== onLoad) {
		t2 = () => {
			...
			if (!isValidURL$1(props.image.src)) return;
			if (hasSetFields) {
				setStatus("good");
				return;
			}
	...
	const errorMessage = (blurred || props.forceValidation) && props.isRequired && !image.src ? "Image URL is required." : void 0;
	let t4;
	if ($[10] !== props) {
		t4 = (e) => {
			if (e.code === "Backspace" || e.code === "Delete") props.onChange(emptyImageData);
		};
		$[10] = props;
		$[11] = t4;
	} else t4 = $[11];
	...
	if ($[13] !== imageLibraryURL) {
		t6 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(Text, { children: [
	...
	if ($[15] !== status || $[16] !== image || $[17] !== props) {
		t7 = status === "loading" ? /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Flex, {
			height: "element.regular",
			width: "element.regular",
			alignItems: "center",
			justifyContent: "center",
			children: /*#__PURE__*/ (0, import_jsx_runtime.jsx)(ProgressCircle, {
				size: "small",
				"aria-label": "Checking…",
				isIndeterminate: true
			})
		}) : image.src ? /*#__PURE__*/ (0, import_jsx_runtime.jsx)(ClearButton, {
			onPress: () => {
	...
	if ($[19] !== props.isRequired || $[20] !== props.autoFocus || $[21] !== errorMessage || $[22] !== onPaste || $[23] !== t4 || $[24] !== image.src || $[25] !== t6 || $[26] !== t7) {
		t8 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(TextField, {
			label: "Image URL",
	...
	let t9;
	if ($[28] !== onChange) {
		t9 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(UploadImageButton, {
			alignSelf: "start",
			onUploaded: (data_0) => {
				onChange(data_0);
			}
	...
	let t10;
	if ($[30] !== t8 || $[31] !== t9) {
		t10 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(VStack, {
			gap: "medium",
			children: [t8, t9]
		});
		$[30] = t8;
	...
	if ($[33] !== status || $[34] !== image || $[35] !== props || $[36] !== onChange) {
		t11 = status === "good" ? /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			...
			/*#__PURE__*/ (0, import_jsx_runtime.jsx)(ImageDimensionsInput, {
				src: image.src,
				image,
				onChange: (dimensions) => {
					onChange({
	...
	let t12;
	if ($[38] !== t10 || $[39] !== t11) {
		t12 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(VStack, {
			gap: "xlarge",
			padding: "large",
			children: [t10, t11]
		});
...
function CloudImageFieldInput(props) {
	...
	if ($[3] !== props.schema.description || $[4] !== descriptionId) {
		t2 = !!props.schema.description && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Text, {
			id: descriptionId,
			size: "regular",
			color: "neutralSecondary",
			children: props.schema.description
	...
	let t3;
	if ($[6] !== t1 || $[7] !== t2) {
		t3 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(VStack, {
			backgroundColor: "surface",
			borderBottom: "muted",
	...
	if ($[16] !== t6 || $[17] !== t7 || $[18] !== props.autoFocus || $[19] !== props.isRequired || $[20] !== props.forceValidation) {
		t8 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(ImageField, {
			image: t6,
			onChange: t7,
			autoFocus: props.autoFocus,
			isRequired: props.isRequired,
	...
	if ($[22] !== labelId || $[23] !== t0 || $[24] !== t3 || $[25] !== t8) {
		t9 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(VStack, {
...
function DateFieldInput(props) {
	...
	let t5;
	if ($[6] !== props.label || $[7] !== props.description || $[8] !== props.autoFocus || $[9] !== t1 || $[10] !== t2 || $[11] !== onBlur || $[12] !== t3 || $[13] !== t4) {
		t5 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(TextField, {
			label: props.label,
			description: props.description,
			type: "date",
			onChange: t1,
...
function FileFieldInput(props) {
	...
	if ($[1] !== labelId || $[2] !== t2 || $[3] !== props.label) {
		t3 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(FieldLabel, {
			id: labelId,
			elementType: "span",
			isRequired: t2,
	...
	if ($[5] !== props.description || $[6] !== descriptionId) {
		t4 = props.description && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(FieldDescription, {
			id: descriptionId,
			children: props.description
		});
		$[5] = props.description;
	...
	let t5;
	if ($[8] !== props) {
		t5 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(ActionButton, {
			onPress: async () => {
	...
	if ($[10] !== value || $[11] !== props || $[12] !== onBlur || $[13] !== objectUrl) {
		t6 = value !== null && /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/*#__PURE__*/ (0, import_jsx_runtime.jsx)(ActionButton, {
			prominence: "low",
			onPress: () => {
				props.onChange(null);
				onBlur();
			...
			children: "Remove"
		}), objectUrl && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Button, {
			href: objectUrl,
	...
	let t7;
	if ($[15] !== t5 || $[16] !== t6) {
		t7 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(ButtonGroup, { children: [t5, t6] });
		$[15] = t5;
		$[16] = t6;
		$[17] = t7;
	} else t7 = $[17];
	...
	if ($[18] !== isInEditor || $[19] !== value || $[20] !== props) {
		t8 = isInEditor && value !== null && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(TextField, {
			label: "Filename",
			onChange: (filename) => {
				props.onChange({
					...value,
	...
	if ($[22] !== props || $[23] !== blurred || $[24] !== value) {
		...
		t9 = (props.forceValidation || blurred) && ((_props$validation2 = props.validation) === null || _props$validation2 === void 0 ? void 0 : _props$validation2.isRequired) && value === null && /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(FieldMessage, { children: [props.label, " is required"] });
		$[22] = props;
		$[23] = blurred;
		$[24] = value;
		$[25] = t9;
	...
	if ($[26] !== t1 || $[27] !== labelId || $[28] !== t3 || $[29] !== t4 || $[30] !== t7 || $[31] !== t8 || $[32] !== t9) {
		t10 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(Flex, {
			"aria-describedby": t1,
			"aria-labelledby": labelId,
			direction: "column",
			gap: "medium",
...
function MultiRelationshipInput(props) {
	var _props$validation;
	const valAsObjects = (0, import_react.useMemo)(() => {
	...
	const [errorMessage, setErrorMessage] = (0, import_react.useState)(_errorMessage);
	...
	return /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(VStack, {
		gap: "medium",
		minWidth: 0,
		children: [/*#__PURE__*/ (0, import_jsx_runtime.jsx)(_Combobox, {
			label: props.label,
			description: props.description,
			selectedKey: null,
			placeholder: items.length === 0 ? "All selected" : void 0,
			onSelectionChange: (key_0) => {
				if (typeof key_0 === "string") props.onChange([...props.value, key_0]);
			},
			...
			errorMessage,
			width: "auto",
			children: (item) => /*#__PURE__*/ (0, import_jsx_runtime.jsx)($05678f3aee5e7d1a$export$6d08773d2e66f8f2, { children: item.slug }, item.slug)
		}), /*#__PURE__*/ (0, import_jsx_runtime.jsx)(MultiRelationshipListView, {
			autoFocus: props.autoFocus,
			forceValidation: props.forceValidation,
			onChange: (value) => {
...
function MultiRelationshipListView(props) {
	...
	let onMove = (keys, target) => {
		...
		const allKeys = props.elements.map((x_0) => ({ key: x_0.key }));
	...
	const dragType = (0, import_react.useMemo)(() => Math.random().toString(36), []);
	let { dragAndDropHooks } = useDragAndDrop({
		...
		async onDrop(e) {
			if (e.target.type !== "root" && e.target.dropPosition !== "on") {
				let keys_1 = [];
				for (let item of e.items) if (item.kind === "text") {
					let key_1;
		...
		getDropOperation(target_0) {
			if (target_0.type === "root" || target_0.dropPosition === "on") return "cancel";
			return "move";
		}
	});
	return /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(_ActionBarContainer, {
		maxHeight: "scale.3400",
		minHeight: "scale.1600",
		children: [/*#__PURE__*/ (0, import_jsx_runtime.jsx)(_ListView, {
			...
			UNSAFE_className: css({ borderRadius: tokenSchema.size.radius.regular }),
			children: (item_0) => {
				const label = item_0.key;
				return /*#__PURE__*/ (0, import_jsx_runtime.jsx)($05678f3aee5e7d1a$export$6d08773d2e66f8f2, {
					textValue: label,
					children: label
				}, item_0.key);
			}
		}), /*#__PURE__*/ (0, import_jsx_runtime.jsx)(_ActionBar, {
			selectedItemCount: selectedKeys === "all" ? "all" : selectedKeys.size,
			onClearSelection: () => setSelectedKeys(/* @__PURE__ */ new Set()),
			onAction: (key_2) => {
				if (key_2 === "delete") {
					let newItems = props.elements;
					if (selectedKeys instanceof Set) newItems = props.elements.filter((item_1) => !selectedKeys.has(item_1.key));
					else if (selectedKeys === "all") newItems = [];
					props.onChange(newItems);
					setSelectedKeys(/* @__PURE__ */ new Set());
				}
			},
			children: /*#__PURE__*/ (0, import_jsx_runtime.jsxs)($05678f3aee5e7d1a$export$6d08773d2e66f8f2, {
				textValue: "Remove",
				children: [/*#__PURE__*/ (0, import_jsx_runtime.jsx)(Icon, { src: trash2Icon }), /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Text, { children: "Remove" })]
			}, "delete")
		})]
	});
}
...
function MultiselectFieldInput(props) {
	...
	if ($[0] !== labelId || $[1] !== props.label) {
		t1 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(FieldLabel, {
			elementType: "span",
			id: labelId,
			children: props.label
		});
	...
	if ($[3] !== props.description || $[4] !== descriptionId) {
		t2 = props.description && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Text, {
			id: descriptionId,
			size: "small",
			color: "neutralSecondary",
			children: props.description
	...
	let t3;
	if ($[6] !== props) {
		t3 = props.options.map((option) => /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Checkbox, {
			isSelected: props.value.includes(option.value),
			onChange: () => {
				if (props.value.includes(option.value)) props.onChange(props.value.filter((x) => x !== option.value));
				else props.onChange([...props.value, option.value]);
			},
	...
	if ($[8] !== labelId || $[9] !== t0 || $[10] !== t1 || $[11] !== t2 || $[12] !== t3) {
		t4 = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(Flex, {
			role: "group",
			"aria-labelledby": labelId,
			"aria-describedby": t0,
			direction: "column",
...
function PathReferenceInput(props) {
	...
	const [blurred, onBlur] = (0, import_react.useReducer)(t2, false);
	...
	if ($[11] !== props) {
		t7 = (key) => {
			if (typeof key === "string" || key === null) props.onChange(key);
		};
		$[11] = props;
		$[12] = t7;
	} else t7 = $[12];
	...
	if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
		t9 = (item) => /*#__PURE__*/ (0, import_jsx_runtime.jsx)($05678f3aee5e7d1a$export$6d08773d2e66f8f2, { children: item.path }, item.path);
		$[13] = t9;
	} else t9 = $[13];
	let t10;
	if ($[14] !== props.label || $[15] !== props.description || $[16] !== props.value || $[17] !== props.autoFocus || $[18] !== t7 || $[19] !== onBlur || $[20] !== t8 || $[21] !== errorMessage || $[22] !== options) {
		t10 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(_Combobox, {
			label: props.label,
			description: props.description,
			selectedKey: props.value,
...
function RelationshipInput(props) {
	...
	if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
		t7 = (item) => /*#__PURE__*/ (0, import_jsx_runtime.jsx)($05678f3aee5e7d1a$export$6d08773d2e66f8f2, { children: item.slug }, item.slug);
		$[9] = t7;
	} else t7 = $[9];
	let t8;
	if ($[10] !== props.label || $[11] !== props.description || $[12] !== props.value || $[13] !== props.autoFocus || $[14] !== t5 || $[15] !== onBlur || $[16] !== options || $[17] !== t6 || $[18] !== errorMessage) {
		t8 = /*#__PURE__*/ (0, import_jsx_runtime.jsx)(_Combobox, {
			label: props.label,
			description: props.description,
			selectedKey: props.value,
...
function SlugFieldInput(props) {
	...
	const slugContext = (0, import_react.useContext)(SlugFieldContext);
	const path = (0, import_react.useContext)(PathContext);
	const slugInfo = path.length === 1 && path[0] === (slugContext === null || slugContext === void 0 ? void 0 : slugContext.field) ? slugContext : {
		slugs: emptySet,
		glob: "*"
	};
	const [blurredName, setBlurredName] = (0, import_react.useState)(false);
	const [blurredSlug, setBlurredSlug] = (0, import_react.useState)(false);
	const [shouldGenerateSlug, setShouldGenerateSlug] = (0, import_react.useState)(props.value === props.defaultValue);
	const generateSlug = (name) => {
		const generated = props.naiveGenerateSlug(name);
		if (slugInfo.slugs.has(generated)) {
			let i = 1;
			while (slugInfo.slugs.has(`${generated}-${i}`)) i++;
			return `${generated}-${i}`;
		}
		return generated;
	};
		...
		children: [/*#__PURE__*/ (0, import_jsx_runtime.jsx)(TextField, {
			...
			children: [/*#__PURE__*/ (0, import_jsx_runtime.jsx)(TextField, {
				...
				children: [/*#__PURE__*/ (0, import_jsx_runtime.jsxs)(ActionButton, {
					...
					children: [/*#__PURE__*/ (0, import_jsx_runtime.jsx)(Icon, {
						src: refreshCwIcon,
						UNSAFE_className: css({ [containerQueries.above.mobile]: { display: "none" } })
					}), /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Text, {
						UNSAFE_className: css({ [containerQueries.below.tablet]: { display: "none" } }),
						children: "Regenerate"
					})]
				}), slugErrorMessage !== void 0 && /*#__PURE__*/ (0, import_jsx_runtime.jsx)(Box, { height: "element.xsmall" })]
			})]
		})]
	});
}
...
function slug(_args) {
	...
	const naiveGenerateSlug = ((_args$slug = args.slug) === null || _args$slug === void 0 ? void 0 : _args$slug.generate) || import_slugify.default;
	let _defaultValue;
...
function validateUrl(validation, value, label) {
	if (value !== null && (typeof value !== "string" || !isValidURL$1(value))) return `${label} is not a valid URL`;
	if (validation !== null && validation !== void 0 && validation.isRequired && value === null) return `${label} is required`;
}
...
//#endregion
export { BlockWrapper$1 as BlockWrapper, NotEditable, ToolbarSeparator, collection, component, config, index as fields, singleton };
